...
(() => {
   ...
   * @returns {string}
   */
  function leftPad(str: string, totalLength: number): string {
   ...
   * @returns {string}
   */
  function binary2hex(binary: string): string {
   ...
   * @returns {string}
   */
  function hex2binary(hex: string): string {
    const hexLength = 2;
    let binary = '';
   ...
   * @returns {string}
   */
  function utf16CodePoint2utf8Binary(ch: string): string {
    const utf8Arr = [];
   ...
   * @returns {string}
   */
  function str2binary(str: string): string {
    let binary = '';
    for (const ch of str) {
   ...
   * @returns {string}
   */
  function rol(str: string, n: number): string {
   ...
   * @returns {string}
   */
  function binaryCal(x: string, y: string, method: Function): string {
    const a = x || '';
    const b = y || '';
    const result = [];
    let prevResult;
   ...
   * @returns {string}
   */
  function xor(x: string, y: string): string {
   ...
   * @returns {string}
   */
  function and(x: string, y: string): string {
   ...
   * @returns {string}
   */
  function or(x: string, y: string): string {
   ...
   * @returns 
   */
  function calMulti(method: Function) {
   ...
   * @returns {string}
   */
  function FF(X: string, Y: string, Z: string, j: number): string {
   ...
   * @returns {string}
   */
  function GG(X: string, Y: string, Z: string, j: number): string {
   ...
   * @returns {string}
   */
  function CF(V: string, Bi: string): string {
    // 消息扩展
    const wordLength = 32;
    const W = [];
    const M = [];// W'
   ...
   */
  function sm3(content: string | Buffer | Uint8Array): string {
    let binary = '';
    if ((typeof Buffer !== 'undefined' && content instanceof Buffer) || (typeof Uint8Array !== 'undefined' && content instanceof Uint8Array)) {
